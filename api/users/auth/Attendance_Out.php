...
if (!$validLocation) {
    ...
    $errorcode = $api_error_code_class_call::$internalUserWarning;
    $maindata = [];
    $hint = ["Invalid location for clock out. Make sure you are at the correct location."];
    $linktosolve = "https://";
    $api_status_code_class_call->respondBadRequest($maindata, $text, $hint, $linktosolve, $errorcode);
}
    ...
    $attendance_result = Utility_Functions ::takeAttendanceOut($user_id, $mac_address);

    if ($attendance_result) {
        // Attendance recorded successfully
        $text = $api_response_class_call::$attendanceOutRecorded;
